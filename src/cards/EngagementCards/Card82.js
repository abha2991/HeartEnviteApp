import Engagement from "../../images/Engagement/Engagement_6_1.png";
import {
  ImageBackground,
  View,
  StyleSheet,
...
import {
  cardControllerEngagementCard,
  useAuthControllerViewer,
  useCardControllerEngagementCard,
} from "../../api";
...
const Card82 = () => {
  ...
  const { mutateAsync } = useCardControllerEngagementCard({});
